...
---
This guide shows how to add examples to [LangSmith datasets](/langsmith/home) from nodes in the thread log. This is useful to evaluate individual steps of the agent.
...
See [Evaluating intermediate steps](/langsmith/evaluate-graph#evaluating-intermediate-steps) for more details on how to evaluate intermediate steps.
