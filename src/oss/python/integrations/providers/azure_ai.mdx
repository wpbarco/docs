...
All LangChain integrations with the [Microsoft Azure](https://azure.micorsoft.com/) and its related projects.
...
See a [usage example](/oss/python/integrations/vectorstores/azure_cosmosdb_mongo_vcore).
