...
<Columns cols={2}>
    <Card title="Vertex AI" icon="comments" href="/oss/integrations/chat/google_vertex_ai_palm" cta="Get started" arrow>
        Access chat models like Gemini via the Vertex AI platform.
    </Card>
    <Card title="Anthropic on Vertex AI Model Garden" icon="comments" href="/oss/integrations/llms/google_vertex_ai_palm" cta="Get started" arrow />
</Columns>
...
<Columns cols={2}>
    <Card title="Vertex AI Model Garden" icon="i-cursor" href="/oss/integrations/llms/google_vertex_ai_palm#vertex-model-garden" cta="Get started" arrow>
...
<Columns cols={2}>
    <Card title="Vertex AI" icon="layer-group" href="/oss/integrations/text_embedding/google_vertex_ai_palm" cta="Get started" arrow>
