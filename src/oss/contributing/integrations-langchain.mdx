...
<Steps>
    ...
    <Step title="Add documentation">
        ...
        <Accordion title="Integration documentation guide" icon="book">
            ...
            - [Chat models](/oss/integrations/chat/TEMPLATE)
            - [Tools and toolkits](/oss/integrations/tools/TEMPLATE)
            - [Retrievers](/oss/integrations/retrievers/TEMPLATE)
            - Text splitters - Coming soon
            - Embedding models - Coming soon
            - [Vector stores](/oss/integrations/vectorstores/TEMPLATE)
