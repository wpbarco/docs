...
<Tip>
To learn more about tools and how to configure `ToolNode`, see [Tools](./langchain-tools).
</Tip>
...
<Tip>
To learn about **short-term memory**, see [Memory](./langchain-memory).
</Tip>

For persistent memory across sessions, use checkpointers and stores.

<Tip>
To learn about **long-term memory**, see [Memory](./langchain-memory).
</Tip>
