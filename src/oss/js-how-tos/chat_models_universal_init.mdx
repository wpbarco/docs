...
- [Tool calling](/oss/concepts/tools)
...
`initChatModel` requires `langchain>=0.2.11`. See [this guide](/oss/how-to/installation/#installing-integration-packages) for some considerations to take when upgrading.
