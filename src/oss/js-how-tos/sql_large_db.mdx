...
- [Question answering over SQL data](/oss/tutorials/sql_qa)
...
Next, check out some of the other guides in this section, like [how to validate queries](/oss/how-to/sql_query_checking).
You might also be interested in the query analysis guide [on handling high cardinality](/oss/how-to/query_high_cardinality).
