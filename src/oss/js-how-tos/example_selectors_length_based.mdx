...
- [Example selectors](/oss/how-to/example_selectors)
...
Next, check out this guide on how to use a [similarity based example selector](/oss/how-to/example_selectors_similarity).
