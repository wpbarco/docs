...
Compatible Vectorstores: [`PGVector`](/oss/integrations/vectorstores/pgvector), [`Chroma`](/oss/integrations/vectorstores/chroma), [`CloudflareVectorize`](/oss/integrations/vectorstores/cloudflare_vectorize),
[`ElasticVectorSearch`](/oss/integrations/vectorstores/elasticsearch), [`FAISS`](/oss/integrations/vectorstores/faiss), [`MariaDB`](/oss/integrations/vectorstores/mariadb), [`MomentoVectorIndex`](/oss/integrations/vectorstores/momento_vector_index),
[`Pinecone`](/oss/integrations/vectorstores/pinecone), [`SupabaseVectorStore`](/oss/integrations/vectorstores/supabase), [`VercelPostgresVectorStore`](/oss/integrations/vectorstores/vercel_postgres),
[`Weaviate`](/oss/integrations/vectorstores/weaviate), [`Xata`](/oss/integrations/vectorstores/xata)
