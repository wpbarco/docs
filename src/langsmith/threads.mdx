...
You can [add metadata to your traces](./add-metadata-tags) in LangSmith in a variety of ways, this code will show how to do so dynamically, but the linked guide has various other ways to add thread identifier metadata to your traces.
