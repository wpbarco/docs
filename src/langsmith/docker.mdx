...
5. Configuration
   1. There are several configuration options that you can set in the `.env` file. You can find more information on the available configuration options in the [Configuration](/langsmith/configure-for-scale) section.
...
2. Visit the exposed port of the `cli-langchain-frontend-1` container on your browser
   ...
   ![.langsmith\_ui.png](images/langsmith-ui.png)
