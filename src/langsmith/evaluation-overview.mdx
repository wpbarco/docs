...
![Dataset](images/dataset-concept.png)
...
![Example](images/example-concept.png)
...
* **Custom code**: Define [custom evaluators](/langsmith/custom-evaluator) as Python or TypeScript functions and run them client-side using the SDKs or server-side via the UI.
...
![Experiment view](images/experiment-view.png)
...
![Comparison view](images/comparison-view.png)
...
![Agent](images/langgraph-agent.png)
...
![Agent-eval](images/agent-eval.png)
