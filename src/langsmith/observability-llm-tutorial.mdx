...
![](images/tracing-tutorial-openai.png)
...
![](images/tracing-tutorial-chain.png)
...
![](images/tracing-tutorial-feedback.png)
...
![](images/tracing-tutorial-filtering.png)
...
![](images/tracing-tutorial-monitor.png)
...
![](images/tracing-tutorial-monitor-metadata.png)

Once we select this, we will start to see charts grouped by this attribute:

![](images/tracing-tutorial-monitor-grouped.png)
...
![](images/tracing-tutorial-monitor-drilldown.png)
