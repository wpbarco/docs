...
You can also nest runs within other traced functions to create a hierarchy of associated runs. Here's an example using the [`traceable`](/langsmith/annotate-code#use-traceable--traceable) method:
