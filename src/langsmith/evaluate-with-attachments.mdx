...
![Add trace with attachments to dataset](images/add-trace-with-attachments-to-dataset.png)
...
![Create example with attachments](images/create-example-with-attachments.png)

Once uploaded, you can view examples with attachments in the LangSmith UI. Each attachment will be rendered with a preview for easy inspection. ![Attachments with examples](images/attachments-with-examples.png)
...
![Adding multimodal variable](images/adding-multimodal-variable.gif)
...
![Attachment editing](images/attachment-editing.gif)
