...
Now that we have defined all of our tools, we can use LangGraph's [`create_agent`](https://langchain-ai.github.io/langgraph/reference/prebuilt/)/[`createAgent`](https://langchain-ai.github.io/langgraphjs/reference/functions/langgraph_prebuilt.createAgent.html) to create our agent.
