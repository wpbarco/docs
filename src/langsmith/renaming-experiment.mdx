...
You can rename an experiment immediately after running it by editing its name in the Playground table header. ![Edit name in playground](images/rename-in-playground.png)
...
![Edit name in experiments view](images/rename-in-experiments-view.png)