...
After setting the above, you should be able to run your code and see the results in your self-hosted instance. We recommend running through the [*quickstart guide*](/langsmith/observability-quickstart) to get a feel for how to use LangSmith.
