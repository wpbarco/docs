...
![Add to evaluator queue](images/add-to-evaluator-queue.gif)
...
![Evaluator Playground](images/evaluator-pg.gif)
...
![Evaluator Playground](images/alignment_evaluator-pg.gif)
...
![Enable reasoning](images/enable-reasoning.gif)
