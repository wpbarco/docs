...
<Info>
  ...
  * Runnable: [Python](https://python.langchain.com/do/langsmith/observability-overview/runnables/) and [JS/TS](https://js.langchain.com/do/langsmith/observability-overview/runnables/)
</Info>

`langchain` [Runnable](https://python.langchain.com/do/langsmith/observability-overview/runnables/) objects (such as chat models, retrievers, chains, etc.) can be passed directly into `evaluate()` / `aevaluate()`.
...
![Runnable Evaluation](images/runnable-eval.png)
