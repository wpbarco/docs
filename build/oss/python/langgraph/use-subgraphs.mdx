...
This guide explains the mechanics of using [subgraphs](/oss/python/subgraphs). A common application of subgraphs is to build [multi-agent](/oss/python/langchain/multi-agent) systems.
