...
<Tabs>
    <Tab title="Chat Models">
        ...
        See the [chat model integration guide](/oss/python/integrations/guide/chat) for details on implementing a chat model integration.
    </Tab>
    <Tab title="Tools">
        ...
        See the [tool integration guide](/oss/python/integrations/guide/tools) for details on implementing a tool integration.
    </Tab>
    <Tab title="Retrievers">
        ...
        See the [retriever integration guide](/oss/python/integrations/guide/retrievers) for details on implementing a retriever integration.
    </Tab>
    <Tab title="Vector Stores">
        ...
        See the [vector store integration guide](/oss/python/integrations/vector-stores) for details on implementing a vector store integration.
    </Tab>
    <Tab title="Embeddings">
        ...
        See the [embedding model integration guide](/oss/python/integrations/embeddings) for details on implementing an embedding model integration.
    </Tab>
</Tabs>
