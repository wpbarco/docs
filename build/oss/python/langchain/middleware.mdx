...
| Parameter | Description | Default |
|-----------|-------------|---------|
| [`system_prompt`](https://reference.langchain.com/python/langchain/agents/#langchain.agents.create_agent(system_prompt)) | Custom system prompt for guiding todo usage | Built-in prompt |
...
| [`system_prompt`](https://reference.langchain.com/python/langchain/agents/#langchain.agents.create_agent(system_prompt)) | Instructions for the selection model | Built-in prompt |
