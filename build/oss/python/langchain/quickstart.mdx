...
<Steps>
    ...
    <Step title="Create tools">
        ...
        <Tip>
            ...
            We've defined them here as plain Python functions, but LangChain's [`@tool` decorator](https://reference.langchain.com/python/langchain/tools/#langchain.tools.tool) is often used to add extra metadata.
        </Tip>
