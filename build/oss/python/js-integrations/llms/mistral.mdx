...
<Tip>
**Want to run Mistral's models locally? Check out our [Ollama integration](/oss/python/integrations/chat/ollama).**

:::

</Tip>caution
You are currently on a page documenting the use of Mistral models as [text completion models](/oss/python/concepts/text_llms). Many popular models available on Mistral are [chat completion models](/oss/python/concepts/chat_models).

You may be looking for [this page instead](/oss/python/integrations/chat/mistral/).
:::
