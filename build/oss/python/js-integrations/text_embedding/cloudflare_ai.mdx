...
Below is an example worker that uses Workers AI embeddings with a [Cloudflare Vectorize vectorstore](/oss/python/integrations/vectorstores/cloudflare_vectorize/).
