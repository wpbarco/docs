...
This guide will help you getting started with such a retriever backed by a [Qdrant vector store](/oss/python/integrations/vectorstores/qdrant). For detailed documentation of all features and configurations head to the [API reference](https://api.js.langchain.com/classes/langchain.retrievers_self_query.SelfQueryRetriever.html).
...
Set up a Qdrant instance as documented [here](/oss/python/integrations/vectorstores/qdrant). Set the following environment variables:
...
Like other retrievers, Qdrant self-query retrievers can be incorporated into LLM applications via [chains](/oss/python/how-to/sequence/).
