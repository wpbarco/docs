...
This will help you getting started with `ChatGoogleGenerativeAI` [chat models](/oss/python/concepts/chat_models). For detailed documentation of all `ChatGoogleGenerativeAI` features and configurations head to the [API reference](https://api.js.langchain.com/classes/langchain_google_genai.ChatGoogleGenerativeAI.html).
...
Click [here](/oss/python/integrations/chat/google_vertex_ai) to read the docs.
</Tip>
...
Tool calling with Google AI is mostly the same [as tool calling with other models](/oss/python/how-to/tool_calling), but has a few restrictions on schema.
