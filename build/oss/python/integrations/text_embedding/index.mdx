...
| [OpenAI on Azure](/oss/python/integrations/text_embedding/azureopenai)        | [`langchain-openai`](https://python.langchain.com/api_reference/openai/embeddings/langchain_openai.embeddings.azure.AzureOpenAIEmbeddings.html)                    |
