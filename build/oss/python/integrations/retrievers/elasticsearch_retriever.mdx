...
We can also incorporate retrievers into [chains](/oss/python/how-to/sequence/) to build larger applications, such as a simple [RAG](/oss/python/langchain/rag/) application. For demonstration purposes, we instantiate an OpenAI chat model as well.
