...
Note that all [vector stores](/oss/python/integrations/vectorstores) can be [cast to retrievers](/oss/python/how-to/vectorstore_retriever/).
...
<Card title="Self-querying retrievers" icon="link" href="/oss/python/integrations/retrievers/self_query" arrow="true" cta="View guide" />
