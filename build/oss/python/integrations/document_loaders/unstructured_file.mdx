...
Please see [this guide](/oss/python/python/integrations/providers/unstructured) for more instructions on setting up Unstructured locally, including setting up required system dependencies.
