...
<Warning>
**You are currently on a page documenting the use of AI/ML API models as [text completion models](/oss/python/concepts/text_llms). Many of the latest and most popular AI/ML API models are [chat completion models](/oss/python/langchain/models).**
...
You can easily combine the LLM with a prompt template for structured inputs using [LCEL](/oss/python/concepts/lcel):
