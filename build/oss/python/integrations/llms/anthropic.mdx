...
<Warning>
**You are currently on a page documenting the use of Anthropic legacy Claude 2 models as [text completion models](/oss/python/concepts/text_llms). The latest and most popular Anthropic models are [chat completion models](/oss/python/langchain/models), and the text completion models have been deprecated.**
