...
<Warning>
**You are currently on a page documenting the use of Cohere models as [text completion models](/oss/python/concepts/text_llms). Many popular Cohere models are [chat completion models](/oss/python/langchain/models).**
