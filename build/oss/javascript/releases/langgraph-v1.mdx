...
[`StateGraph`](https://reference.langchain.com/javascript/TBD) now accepts a map of interrupt types in the constructor to more closely constrain the types of interrupts that can be used within a graph.
