...
1. A list of tools (created with [`tool`](https://reference.langchain.com/javascript/functions/_langchain_core.tools.tool.html) function, or object that represents a built-in provider tool)
2. A configured [`ToolNode`](https://reference.langchain.com/javascript/classes/langchain.index.ToolNode.html)


#### Pass a list of tools

Passing a list of tools to the agent will create a [`ToolNode`](https://reference.langchain.com/javascript/classes/langchain.index.ToolNode.html) under the hood. This is the simplest way to set up a tool-calling agent:
...
Alternatively, you can create a [`ToolNode`](https://reference.langchain.com/javascript/classes/langchain.index.ToolNode.html) directly and pass it to the agent. This allows you to customize the tool node's behavior, such as handling tool errors:
...
<Tip>
Learn more about how to use [`ToolNode`](https://reference.langchain.com/javascript/classes/langchain.index.ToolNode.html) in [Tools](/oss/javascript/langchain/tools).
</Tip>
