...
<Note>
    This page covers the core concepts and usage of models in LangChain. If you're looking for provider-specific integrations, head over to the [integrations page](/oss/javascript/integrations/providers).
</Note>
