...
To stream agent progress, use the [`stream`](https://reference.langchain.com/javascript/TBD) method with `streamMode: "updates"`. This emits an event after every agent step.
