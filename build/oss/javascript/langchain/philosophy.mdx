...
This includes other components you may want to integrate with LLMs - we strive to make it easy to define [tools](/oss/javascript/langchain/tools) that LLMs can use dynamically, as well help with parsing of and access to unstructured data.
