...
Pass one or more of the following stream modes as a list to the [`stream`](https://reference.langchain.com/javascript/TBD) method:
...
LangGraph graphs expose the [`stream`](https://reference.langchain.com/javascript/TBD) method to yield streamed outputs as iterators.
