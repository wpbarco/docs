...
This guide explains the mechanics of using [subgraphs](/oss/javascript/langgraph/subgraphs). A common application of subgraphs is to build [multi-agent](/oss/javascript/langchain/multi-agent) systems.
