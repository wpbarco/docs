...
<Tip>
    **LangGraph v1.0**
    ...
    See the [release notes](/oss/javascript/javascript/releases/langgraph-v1) and [migration guide](/oss/javascript/javascript/migrate/langgraph-v1) for a complete list of changes and instructions on how to upgrade your code.
</Tip>
