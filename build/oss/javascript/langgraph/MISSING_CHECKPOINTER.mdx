...
This happens when a `checkpointer` is missing in the `compile()` method of [`StateGraph`](https://reference.langchain.com/javascript/TBD) or @[`@entrypoint`].

## Troubleshooting

The following may help resolve this error:

-   Initialize and pass a checkpointer to the `compile()` method of [`StateGraph`](https://reference.langchain.com/javascript/TBD) or @[`@entrypoint`].
