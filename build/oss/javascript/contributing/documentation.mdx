...
**Existing references**
- [LangChain Python API reference](https://reference.langchain.com/python/) (auto-generated from docstrings)
- [LangChain JavaScript/TypeScript API reference](https://reference.langchain.com/javascript/) (auto-generated from docstrings)
