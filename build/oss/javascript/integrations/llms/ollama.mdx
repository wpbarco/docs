...
<Warning>
**You are currently on a page documenting the use of Ollama models as [text completion models](/oss/javascript/concepts/text_llms). Many popular models available on Ollama are [chat completion models](/oss/javascript/langchain/models).**
