...
| [Tool calling](/oss/javascript/langchain/tools) | [Structured output](/oss/javascript/langchain/structured-output) | JSON mode | [Image input](/oss/javascript/how-to/multimodal_inputs/) | Audio input | Video input | [Token-level streaming](/oss/javascript/langchain/streaming/) | [Token usage](/oss/javascript/how-to/chat_token_usage_tracking/) | [Logprobs](/oss/javascript/how-to/logprobs/) |
| :---: | :---: | :---: | :---: |  :---: | :---: | :---: | :---: | :---: |
| ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ✅ | ✅ | ✅ |
...
Tool calling with OpenAI models works in a similar to [other models](/oss/javascript/langchain/tools). Additionally, the following guides have some information especially relevant to OpenAI:

- [How to: disable parallel tool calling](/oss/javascript/langchain/tools_parallel/)
- [How to: force a tool call](/oss/javascript/how-to/tool_choice/)
- [How to: bind model-specific tool formats to a model](/oss/javascript/langchain/tools#binding-model-specific-formats-advanced).
