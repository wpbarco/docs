...
See a [usage example](/oss/javascript/integrations/llms/amazon_api_gateway).
...
See a [usage example](/oss/javascript/integrations/llms/sagemaker).
...
See a [usage example](/oss/javascript/integrations/text_embedding/sagemaker-endpoint).
```python
...
See a [usage example for S3DirectoryLoader](/oss/javascript/integrations/document_loaders/aws_s3_directory).

See a [usage example for S3FileLoader](/oss/javascript/integrations/document_loaders/aws_s3_file).
...
See a [usage example](/oss/javascript/integrations/document_loaders/amazon_textract).
...
See a [usage example](/oss/javascript/integrations/document_loaders/athena).
...
See a [usage example](/oss/javascript/integrations/document_loaders/glue_catalog).
...
See a [usage example](/oss/javascript/integrations/vectorstores/opensearch#using-aos-amazon-opensearch-service).
...
See [detail configuration instructions](/oss/javascript/integrations/vectorstores/documentdb).
...
See a [usage example](/oss/javascript/integrations/vectorstores/documentdb).
...
```
See a [usage example](/oss/javascript/integrations/vectorstores/memorydb).
...
See a [usage example](/oss/javascript/integrations/retrievers/amazon_kendra_retriever).
...
See a [usage example](/oss/javascript/integrations/retrievers/bedrock).
...
See a [usage example](/oss/javascript/integrations/tools/awslambda).
...
See a [usage example](/oss/javascript/integrations/memory/aws_dynamodb).
...
See a [usage example](/oss/javascript/integrations/graphs/amazon_neptune_open_cypher).
...
See a [usage example](/oss/javascript/integrations/graphs/amazon_neptune_sparql).
...
See a [usage example](/oss/javascript/integrations/callbacks/sagemaker_tracking).
