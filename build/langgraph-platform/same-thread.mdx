...
You'll see that the second agent will respond using information from the [checkpoint](/oss/python/graph-api#checkpointer-state) generated in the thread by the first agent as context.
