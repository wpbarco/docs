...
1. When troubleshooting parameter-related errors in the playground, such as:
    ...
    If you receive an error about unnecessary parameters (which is more common when using [LangChain JS](/oss/python/javascript/langchain/overview) for run tracing), you can use this field to remove the extra parameters.
